    ...
    <div className="">
      ...
      <div className="grid grid-cols-2 gap-9 text-black">
        <div className="game-mode">
          ...
          <Link href={{ pathname: "/game/pong", query: { mode: 'online' } }} className="mode-btn transition-all">
            <div>Play now</div>
          </Link>
        </div>
        <div className="p-4 game-mode robot">
          ...
          <Link href={{ pathname: "/game/pong", query: { mode: 'ai' } }} className="mode-btn transition-all">
            <div>Play now</div>
          </Link>
        </div>
        <div className="p-4 game-mode">
          ...
          <Link href={{ pathname: "/game/pong", query: { mode: 'offline' } }} className="mode-btn transition-all">
            <div>Play now</div>
          </Link>
        </div>
