...
function Profile() {
    ...
    const [levelData, setLevelData] = useState({ currentLevel: 0, nextLevel: 0, levelProgress: 0 });
  ...
  if (playedGames == 1 )
    ...
    // console.log("User = ",userData.blocking.length);
        ...
        <div className="ProfileTitle">
          ...
          <div className="ProfileBar">
              ...
              <div className="LevelTube">
                  <div className="LevelMarker">Lv.{levelData.currentLevel}</div>
                  <div className="Tube">
                      <div className="LevelProgress" style={{ width: `${levelData.levelProgress}%` }}><span>{levelData.levelProgress.toFixed(0)}%</span></div>
                  </div>
                  <div className="LevelMarker">Lv.{levelData.currentLevel+1}</div>
              </div>
              <div className="Stats">
              <p className="StatText">42 Wins&nbsp;&nbsp;|&nbsp;&nbsp;1 Draw&nbsp;&nbsp;|&nbsp;&nbsp;0 Losses</p>
              </div>
          </div>
        </div>
