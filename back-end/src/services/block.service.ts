...
export class BlockService {
    ...
    */
	...
	// get all blocked users by a user
	// async getBlockingListByUid(uid: string): Promise<User[]> {
	...
	// async getBlockerListByUid(uid: string): Promise<User[]> {
	// 	const blocks = await this.prisma.block.findMany({
	// 		where: {
	// 		blockedUserId: uid,
	// 		},
